...
`main`. Ver la nota en la sección 11: al 19-sep-2026 las 7 copias existían solo en ramas sin
fusionar, lo cual anula el propósito del documento.
...
*Última actualización: 19 de septiembre de 2026, con patrones observados hasta esa fecha en
Vanteris, Radiantte, IMS Global, Contemplación, Salvia Blanca, Samsara y La Manada Feliz. Consolida
la versión del 11-sep (vanteris-web) con los hallazgos de producción documentados el 18-sep
(hosting sin CI visible, ausencia total de proceso de PR) y con el propio incidente de higiene de
ramas detectado el 19-sep.*
